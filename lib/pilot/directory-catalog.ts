...
const PILOT_CATEGORY_DEFS: PilotCategoryDef[] = [
  ...
  },
  {
    groupName: "Food and Drink",
    groupSlug: "food-and-drink",
    name: "Best Cafes and Coffee Shops",
    slug: "cafes-and-coffee-shops",
    description: "Best cafes and coffee shops in your community.",
    displayOrder: 70,
  },
  {
    groupName: "Food and Drink",
    ...
    name: "Best Bakeries",
    slug: "bakeries",
    description: "Best bakeries in your community.",
    displayOrder: 80,
  },
  {
    groupName: "Wellness, Hair and Beauty",
    groupSlug: "wellness-hair-and-beauty",
  ...
  },
  {
    ...
    name: "Best Repair and Maintenance",
    slug: "repair-and-maintenance",
    description: "Best auto repair and maintenance in your community.",
    displayOrder: 30,
  },
  {
    groupName: "Retail Stores",
    groupSlug: "retail-stores",
    name: "Best Clothing Store",
    slug: "clothing-store",
    description: "Best clothing store in your community.",
    displayOrder: 10,
  },
  {
    groupName: "Home, Builders and Contractors",
    groupSlug: "home-builders-and-contractors",
    name: "Best Plumber",
    slug: "plumber",
  ...
  {
    groupName: "Pet and Pet Care",
    groupSlug: "pet-and-pet-care",
    name: "Best Pet Store",
    slug: "pet-store",
...
const BUSINESS_BY_CATEGORY: Record<string, string[]> = {
  ...
  "cafes-and-coffee-shops": ["Daily Grind Cafe", "River Roasters", "Northside Coffee"],
  bakeries: ["Morning Crust Bakery", "Sweet Rise", "Oven & Oak"],
  "hair-salon": ["Studio Cut", "Lumen Hair", "Crown & Comb"],
  "barber-shop": ["Classic Fade Barbers", "Union Street Cuts", "Sharp & Co."],
  "repair-and-maintenance": ["Reliable Auto Care", "City Garage", "Torque & Tune"],
  "clothing-store": ["Thread & Co.", "Market Lane Boutique", "Willow & Pine"],
